...
function typeMessage() {
    const messages = [
         `Dear ${userName},`,
        "On your special day, we want you to know...",
        "Hamesha Ap k sath hain",
       "Api, aap ki life bohot qeemti hai aur har lamha ek nayi opportunity lekar aata hai.",
        "Agle 6 months apke liye bohot important hain – yeh apki life ki direction tay karenge.",
        "Hum yakin rakhte hain ke aap in months mein wo sab hasil karengi jo apne sapnon mein dekha hai.",
        "Kabhi bhi akela feel mat karna, kyunki humari duaen aur support hamesha apke sath hain.",
        "Api, aapke andar wo taqat hai jo har challenge ko jeet mein badal sakti hai.",
        "Khud par yaqeen rakho, aur yaad rakho ke hum apki strength ka hissa hain.",
        "Har din ek nayi shuruaat hai – aur hum apki har shuruaat mein apke sath khare hain.",
        "Happy Birthday once again, Api – may Allah bless you with endless success and happiness.",
